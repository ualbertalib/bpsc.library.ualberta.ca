 ...
 */
$config['site_title']                 = "specialcollections-test.library.ualberta.ca/";       // Site Title, example.com
$config['admin_email']                = "nnunn@ualberta.ca"; // Admin Email, admin@example.com
