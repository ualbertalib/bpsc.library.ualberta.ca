...
<html>
  <head>
	<!-- Google Tag Manager -->
	<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-MX43PRW2');</script>
...
<!-- End Google Tag Manager (noscript) -->
   ...
   <div id="wrap">
      <div class="row-fluid white">
        <div class="container ga_ualberta_blade"><!-- Start Blade -->
...
<div class="container left-padding top-margin">
