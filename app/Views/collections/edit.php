    ...
    <div class="row-fluid">
        ...
        <div class="row-fluid top-margin">
           ...
           <?php if (file_exists("assets/uploads/slides/".$slug.".jpg")): ?>
              <div class='row-fluid'><div class='span6'><img src="/assets/uploads/slides/<?php echo $collection_item['slug']; ?>.jpg" class="slide-edit" /></div><div class='span6'> <a href='/admin/collections/deleteslideimage/<?php echo $collection_item['slug']; ?>/<?php echo $collection_item['slug']; ?>' class='myButton' id='actions' onclick='return confirm("Delete Image?");'>Delete Image</a></div></div>
